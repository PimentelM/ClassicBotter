...
namespace ClassicBotter.Addresses
{
    public static class Player
    {
        ...
        public static uint LastRightClickId;
        public static uint LastRightClickCount;
        public static uint LastLeftClickId;
        public static uint LastLeftClickCount;

        public static uint SlotNeck;
        public static uint SlotRightHand;
        public static uint SlotLeftHand;
